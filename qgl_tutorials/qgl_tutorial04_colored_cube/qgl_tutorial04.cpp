...
Tutorial04::Tutorial04( QWidget *parent ) : QOpenGLWidget(parent) {
...
void Tutorial04::initializeGL(void) {
    ...
    psitionAttr = glGetAttribLocation(programID, "position");
...
void Tutorial04::paintGL(void) {
    ...
    glVertexAttribPointer(
        psitionAttr, // The attribute we want to configure
        3,                           // size
        GL_FLOAT,                    // type
        GL_FALSE,                    // normalized?
        0,                           // stride
